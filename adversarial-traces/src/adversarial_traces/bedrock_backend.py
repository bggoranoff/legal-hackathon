...
# Reasoning levels used unless told otherwise: high for GPT 6 Luna (every role),
# high for GPT 6 Sol (the attacker). Other models get no reasoning setting
# by default (Claude on Bedrock rejects it).
DEFAULT_REASONING = {"gpt-6-luna": "high", "gpt-6-sol": "high"}
_AUTO = "auto"
...
class BedrockConverseBackend:
    ...
    def __init__(self, model: str, *, client: Any = None, region: str | None = None,
        ...
        # By default: high for GPT 6 Luna and GPT 6 Sol, unset for others. None leaves the
